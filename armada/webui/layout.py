...
from ..assets import (CSS_LINKS as _CSS_LINKS, RUN_JS as _RUN_JS, FORM_JS as _FORM_JS,
    ...
    SECTION_EDIT_JS as _SECTION_EDIT_JS, AUTHBAR_JS as _AUTHBAR_JS, SCHEDBAR_JS as _SCHEDBAR_JS, UPDBAR_JS as _UPDBAR_JS, SUPPORT_JS as _SUPPORT_JS, ALEXANDER_JS as _ALEXANDER_JS,
...
def _nav(realm, active: str = "Overview", sec_edit: bool = False) -> str:
    ...
    return (f'<div style="display:flex;align-items:center;gap:22px;padding:0 24px;'
            ...
            f'{_AUTHBAR_JS}{_SCHEDBAR_JS}{_UPDBAR_JS}{_SUPPORT_JS}{_ALEXANDER_JS}{_NOTIFBELL_JS}')
